...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  target_sources(Halide::Tools
    INTERFACE
      FILE_SET "HEADERS"
      TYPE "HEADERS"
      BASE_DIRS "${_IMPORT_PREFIX}/share/Halide/tools"
      FILES "${_IMPORT_PREFIX}/share/Halide/tools/halide_benchmark.h" "${_IMPORT_PREFIX}/share/Halide/tools/halide_image.h" "${_IMPORT_PREFIX}/share/Halide/tools/halide_image_info.h" "${_IMPORT_PREFIX}/share/Halide/tools/halide_malloc_trace.h" "${_IMPORT_PREFIX}/share/Halide/tools/halide_trace_config.h"
  )
else()
  set_property(TARGET Halide::Tools
    APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
      "${_IMPORT_PREFIX}/share/Halide/tools"
  )
endif()
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  target_sources(Halide::ImageIO
    INTERFACE
      ...
      TYPE "HEADERS"
      BASE_DIRS "${_IMPORT_PREFIX}/share/Halide/tools"
      FILES "${_IMPORT_PREFIX}/share/Halide/tools/halide_image_io.h"
  )
else()
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  target_sources(Halide::RunGenMain
    INTERFACE
      ...
      TYPE "HEADERS"
      BASE_DIRS "${_IMPORT_PREFIX}/share/Halide/tools"
      FILES "${_IMPORT_PREFIX}/share/Halide/tools/RunGen.h"
  )
else()
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  target_sources(Halide::ThreadPool
    INTERFACE
      ...
      TYPE "HEADERS"
      BASE_DIRS "${_IMPORT_PREFIX}/share/Halide/tools"
      FILES "${_IMPORT_PREFIX}/share/Halide/tools/halide_thread_pool.h"
  )
else()
